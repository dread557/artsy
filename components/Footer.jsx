    ...
    return (
        <>
            <div className='hidden md:flex flex-col md:flex-row items-center justify-between pl-[30px] pr-[30px] md:pl-[65px] md:pr-[65px] lg:pl-[120px] lg:pr-[120px] mt-8 mb-8 md:mt-[60px]'>
                ...
                <ul className='md:text-2xl flex flex-col gap-[33px]'>
                ...
                <div className='flex flex-col gap-[33px] self-start'>
                    <span className='flex gap-2 items-center'>
                        <AiOutlineMail className='w-[41px] h-[34px]' />
                        <p className='md:text-2xl'>artsystudios@gmail.com</p>
                    </span>
                    <span className='flex gap-2 items-center'>
                        <GoLocation className='w-[41px] h-[34px]' />
                        <p className='md:text-2xl'>Lagos, Nigeria.</p>
                    </span>
                </div>
            </div>
