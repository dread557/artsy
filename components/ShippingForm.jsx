...
const ShippingForm = () => {
    ...
    return (
        <form className='flex flex-col w-full lg:w-[50%] gap-[30px] md:gap-[40px] mt-[30px]' id='shippingForm'>
            ...
            <button className='w-[278px] md:w-[350px] hover:opacity-80 xl:w-[534px] text-[17.51px] md:text-[32px] self-center lg:self-start h-[59.01px] md:h-[107px] mb-5 md:mb-10 bg-[#3341C1] text-white rounded-lg' >
                Proceed to payment
            </button>
        </form>
    )
